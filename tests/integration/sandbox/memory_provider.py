...
class MemoryRuntime(SandboxRuntime):
    ...
    async def code_run(
        ...
        wrapper = _build_code_wrapper(code)
        ...
        try:
            ...
            artifacts, clean_stdout = _extract_artifacts(stdout)
...
def _build_code_wrapper(code: str) -> str:
...
def _extract_artifacts(stdout: str) -> tuple[list[Artifact], str]:
